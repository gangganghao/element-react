    ...
    return (
      <Transition name="r-el-zoom-in-top">
        <View show={showPicker}>
          <div className="r-el-color-dropdown r-el-color-picker__panel">
            <div className="r-el-color-dropdown__main-wrapper">
              <HueSlider
                ref="hue"
                color={color}
                vertical
            ...
            <div className="r-el-color-dropdown__btns">
              <span className="r-el-color-dropdown__value">{currentColor}</span>
              <a
                href="JavaScript:"
