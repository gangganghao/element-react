...
export default class Tooltip extends Component {
  ...
  render(): React.DOM {
    ...
    return (
      <div style={this.style()} className={this.className('r-el-tooltip')} onMouseEnter={this.showPopper.bind(this)} onMouseLeave={this.hidePopper.bind(this)}>
        <div ref="reference" className="r-el-tooltip__rel">
          ...
          !disabled && (
            <Transition name={transition} onEnter={this.onEnter.bind(this)} onAfterLeave={this.onAfterLeave.bind(this)}>
              <View show={this.state.showPopper} >
                <div ref="popper" className={ this.classNames("r-el-tooltip__popper", `is-${effect}`) }>
                  <div>{ content }</div>
