  ...
  (0, _createClass3.default)(Toast, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _libs.Transition,
        { name: 'r-el-message-fade', onAfterLeave: function onAfterLeave() {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: this.classNames('r-el-message', customClass), onMouseEnter: this.stopTimer.bind(this), onMouseLeave: this.startTimer.bind(this) },
            !iconClass && _react2.default.createElement('img', { className: 'r-el-message__img', src: _assets2.default[this.props.type] }),
            _react2.default.createElement(
              'div',
              { className: this.classNames('r-el-message__group', { 'is-with-icon': iconClass }) },
              iconClass && _react2.default.createElement('i', { className: this.classNames('r-el-message__icon', iconClass) }),
              _react2.default.createElement(
                'p',
                null,
                this.props.message
              ),
              this.props.showClose && _react2.default.createElement('div', { className: 'r-el-message__closeBtn r-el-icon-close', onClick: this.onClose.bind(this) })
            )
          )
        )
      );
