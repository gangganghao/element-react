        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: this.classNames('r-el-message-box__wrapper', customClass) },
                _react2.default.createElement(
                  'div',
                  { className: 'r-el-message-box' },
                  title && _react2.default.createElement(
                    'div',
                    { className: 'r-el-message-box__header' },
                    _react2.default.createElement(
                      'div',
                      { className: 'r-el-message-box__title' },
                      title
                    ),
                    showClose && _react2.default.createElement(
                      'button',
                      { type: 'button', className: 'r-el-message-box__headerbtn', 'aria-label': 'Close',
                        onClick: this.handleAction.bind(this, 'cancel') },
                      _react2.default.createElement('i', { className: 'r-el-message-box__close r-el-icon-close' })
                    )
                  ),
                  message && _react2.default.createElement(
                    'div',
                    { className: 'r-el-message-box__content' },
                    _react2.default.createElement('div', { className: this.classNames('r-el-message-box__status', this.typeClass()) }),
                    _react2.default.createElement(
                      'div',
                      { className: 'r-el-message-box__message',
                    ...
                    _react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        'div',
                        { className: 'r-el-message-box__input' },
                        ...
                        _react2.default.createElement(
                          'div',
                          { className: 'r-el-message-box__errormsg', style: {
                  ...
                  _react2.default.createElement(
                    'div',
                    { className: 'r-el-message-box__btns' },
                    _react2.default.createElement(
                      _libs.View,
                    ...
                    _react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        _button2.default,
                        { className: this.classNames('r-el-button--primary', confirmButtonClass),
