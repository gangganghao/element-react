          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'div',
                  { className: 'r-el-dialog__header' },
                  _react2.default.createElement(
                    'span',
                    { className: 'r-el-dialog__title' },
                    title
                  ),
                  showClose && _react2.default.createElement(
                    'button',
                    { type: 'button', className: 'r-el-dialog__headerbtn', onClick: function onClick(e) {
                        return _this2.close(e);
                      } },
                    _react2.default.createElement('i', { className: 'r-el-dialog__close r-el-icon r-el-icon-close' })
                  )
                ),
                children
              )
