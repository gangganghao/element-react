    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'r-el-collapse-item__header', onClick: function onClick() {
              return _onClick(name);
            } },
          _react2.default.createElement('i', { className: 'r-el-collapse-item__header__arrow r-el-icon-arrow-right' }),
          title
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'r-el-collapse-item__wrap' },
            _react2.default.createElement(
              'div',
              { className: 'r-el-collapse-item__content' },
              this.props.children
            )
          )
        )
