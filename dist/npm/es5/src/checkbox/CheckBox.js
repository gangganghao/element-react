  ...
  (0, _createClass3.default)(Checkbox, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'label',
        { style: this.style(), className: this.className('r-el-checkbox') },
        _react2.default.createElement(
          'span',
          { className: this.classNames('r-el-checkbox__input', {
              'is-disabled': this.props.disabled,
              'is-checked': this.state.checked,
              'is-indeterminate': this.props.indeterminate,
              'is-focus': this.state.focus
            }) },
          _react2.default.createElement('span', { className: 'r-el-checkbox__inner' }),
        ...
        _react2.default.createElement(
          'span',
          { className: 'r-el-checkbox__label' },
