...
var Progress = function (_Component) {
  ...
  (0, _createClass3.default)(Progress, [{
    ...
    value: function iconClass() {
      ...
      return type === 'line' ? status === 'success' ? 'r-el-icon-circle-check' : 'r-el-icon-circle-cross' : status === 'success' ? 'r-el-icon-check' : 'r-el-icon-close';
    }
  }, {
    ...
    value: function render() {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              showText && textInside && _react2.default.createElement(
                'div',
                { className: 'r-el-progress-bar__innerText' },
                percentage + '%'
              )
            )
          )
      ...
      return _react2.default.createElement(
        ...
        {
          style: this.style(),
          className: this.className('r-el-progress', 'r-el-progress--' + type, (_className = {}, (0, _defineProperty3.default)(_className, 'is-' + status, !!status), (0, _defineProperty3.default)(_className, 'r-el-progress--without-text', !showText), (0, _defineProperty3.default)(_className, 'r-el-progress--text-inside', textInside), _className))
        },
        progress,
        progressInfo
      );
