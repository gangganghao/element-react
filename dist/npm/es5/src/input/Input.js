...
var Input = function (_Component) {
  ...
  (0, _createClass3.default)(Input, [{
    ...
    value: function render() {
      ...
      var classname = this.classNames(type === 'textarea' ? 'r-el-textarea' : 'r-el-input', size && 'r-el-input--' + size, {
      ...
      if (type === 'textarea') {
        ...
        return _react2.default.createElement(
          ...
          prepend && _react2.default.createElement(
            'div',
            { className: 'r-el-input-group__prepend' },
            prepend
          ),
          typeof icon === 'string' ? _react2.default.createElement(
            'i',
            { className: 'r-el-input__icon r-el-icon-' + icon, onClick: this.handleIconClick.bind(this) },
            prepend
          ) : icon,
          ...
          validating && _react2.default.createElement('i', { className: 'r-el-input__icon r-el-icon-loading' }),
          append && _react2.default.createElement(
            'div',
            { className: 'r-el-input-group__append' },
            append
          )
        );
      }
