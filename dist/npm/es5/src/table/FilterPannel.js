    ...
    value: function renderContent() {
      ...
      if (multiple) {
        content = [React.createElement(
          'div',
          { className: 'r-el-table-filter__content', key: 'content' },
          React.createElement(
            _checkbox2.default.Group,
            { value: filteredValue || [], onChange: this.handleFiltersChange.bind(this), className: 'r-el-table-filter__checkbox-group' },
          ...
          'div',
          { className: 'r-el-table-filter__bottom', key: 'bottom' },
          React.createElement(
            'button',
            {
        ...
        content = React.createElement(
          'ul',
          { className: 'r-el-table-filter__list' },
          React.createElement(
            'li',
            {
          ...
          filters && filters.map(function (filter) {
            return React.createElement(
              ...
              {
                key: filter.value,
                className: _this2.classNames('r-el-table-filter__list-item', { 'is-active': filter.value === filteredValue }),
