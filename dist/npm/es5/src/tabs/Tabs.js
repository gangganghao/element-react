  ...
  (0, _createClass3.default)(Tabs, [{
    ...
    value: function render() {
      ...
      var addButton = editable || addable ? _react2.default.createElement(
        ...
        _react2.default.createElement('i', { className: 'r-el-icon-plus' })
      ) : null;
      var scrollBtn = scrollable ? [_react2.default.createElement(
        ...
        _react2.default.createElement('i', { className: 'r-el-icon-arrow-left' })
        ...
        _react2.default.createElement('i', { className: 'r-el-icon-arrow-right' })
      )] : null;
      this.tabs = [];
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'r-el-tabs__header' },
          addButton,
          _react2.default.createElement(
            'div',
            { className: scrollable ? 'r-el-tabs__nav-wrap is-scrollable' : 'r-el-tabs__nav-wrap' },
            scrollBtn,
            _react2.default.createElement(
              'div',
              { className: 'r-el-tabs__nav-scroll', ref: 'navScroll' },
              _react2.default.createElement(
                'div',
                { className: 'r-el-tabs__nav', ref: 'nav', style: navStyle },
                _react2.default.Children.map(children, function (item, index) {
                  ...
                  return _react2.default.createElement(
                    'div',
                    {
                      key: 'r-el-tabs__item-' + index, ref: function ref(tab) {
                    ...
                    _react2.default.createElement(
                      ...
                      _react2.default.createElement('span', { className: 'r-el-icon-close', onClick: function onClick(e) {
                ...
                _react2.default.createElement(
                  _libs.View,
                  { show: !type },
                  _react2.default.createElement('div', { className: 'r-el-tabs__active-bar', style: barStyle })
                )
              )
            )
          )
