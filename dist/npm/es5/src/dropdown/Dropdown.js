  ...
  (0, _createClass3.default)(Dropdown, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: this.style(), className: this.className('r-el-dropdown') },
        splitButton ? _react2.default.createElement(
          ...
          _react2.default.createElement(
            _button2.default,
            { ref: 'trigger', type: type, size: size, className: 'r-el-dropdown__caret-button' },
            _react2.default.createElement('i', { className: 'r-el-dropdown__icon r-el-icon-caret-bottom' })
          )
