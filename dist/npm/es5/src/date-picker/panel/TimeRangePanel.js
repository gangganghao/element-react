    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'r-el-time-range-picker__content' },
          _react2.default.createElement(
            'div',
            { className: 'r-el-time-range-picker__cell' },
            _react2.default.createElement(
              'div',
              { className: 'r-el-time-range-picker__header' },
              $t('el.datepicker.startTime')
            ),
            _react2.default.createElement(
              'div',
              {
                className: this.classNames('r-el-time-range-picker__body r-el-time-panel__content', { 'has-seconds': isShowSeconds })
              },
        ...
        _react2.default.createElement(
          'div',
          { className: 'r-el-time-panel__footer' },
          _react2.default.createElement(
            'button',
            {
              type: 'button',
