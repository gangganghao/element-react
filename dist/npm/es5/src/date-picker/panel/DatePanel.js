        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            isShowTime && _react2.default.createElement(
              'div',
              { className: 'r-el-date-picker__time-header' },
              _react2.default.createElement(
                'span',
                { className: 'r-el-date-picker__editor-wrap' },
            ...
            currentView !== 'time' && _react2.default.createElement(
              'div',
              { className: 'r-el-date-picker__header' },
              ...
              _react2.default.createElement(
                'span',
                {
                  ...
                  className: 'r-el-date-picker__header-label' },
                this.yearLabel()
              ),
              currentView === PICKER_VIEWS.DATE && _react2.default.createElement(
                'span',
                {
                  ...
                  className: this.classNames('r-el-date-picker__header-label', {
            ...
            _react2.default.createElement(
              'div',
              { className: 'r-el-picker-panel__content' },
              this._pickerContent()
            )
          )
        ),
