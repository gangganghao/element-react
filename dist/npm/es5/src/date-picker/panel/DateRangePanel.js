    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'r-el-picker-panel__body-wrapper' },
          Array.isArray(shortcuts) && _react2.default.createElement(
            'div',
            { className: 'r-el-picker-panel__sidebar' },
          ...
          _react2.default.createElement(
            'div',
            { className: 'r-el-picker-panel__body' },
            isShowTime && _react2.default.createElement(
              'div',
              { className: 'r-el-date-range-picker__time-header' },
              _react2.default.createElement(
                'span',
                { className: 'r-el-date-range-picker__editors-wrap' },
                _react2.default.createElement(
                  'span',
                  { className: 'r-el-date-range-picker__time-picker-wrap' },
              ...
              _react2.default.createElement('span', { className: 'r-el-icon-arrow-right' }),
              _react2.default.createElement(
                'span',
                { className: 'r-el-date-range-picker__editors-wrap is-right' },
                _react2.default.createElement(
                  'span',
                  { className: 'r-el-date-range-picker__time-picker-wrap' },
                  _react2.default.createElement(_input2.default, {
            ...
            _react2.default.createElement(
              'div',
              { className: 'r-el-picker-panel__content r-el-date-range-picker__content is-left' },
              _react2.default.createElement(
                'div',
                { className: 'r-el-date-range-picker__header' },
                _react2.default.createElement('button', {
                  type: 'button',
                  onClick: this.prevYear.bind(this),
                  className: 'r-el-picker-panel__icon-btn r-el-icon-d-arrow-left' }),
                _react2.default.createElement('button', {
                  type: 'button',
                  onClick: this.prevMonth.bind(this),
                  className: 'r-el-picker-panel__icon-btn r-el-icon-arrow-left' }),
                _react2.default.createElement(
                  'div',
                  null,
                  leftLabel
            ...
            _react2.default.createElement(
              'div',
              { className: 'r-el-picker-panel__content r-el-date-range-picker__content is-right' },
              _react2.default.createElement(
                'div',
                { className: 'r-el-date-range-picker__header' },
                _react2.default.createElement('button', {
                  ...
                  className: 'r-el-picker-panel__icon-btn r-el-icon-d-arrow-right' }),
                _react2.default.createElement('button', {
                  type: 'button',
                  onClick: this.nextMonth.bind(this),
                  className: 'r-el-picker-panel__icon-btn r-el-icon-arrow-right' }),
                _react2.default.createElement(
                  'div',
                  null,
                  rightLabel
