...
var Pager = function (_Component) {
  ...
  (0, _createClass3.default)(Pager, [{
    ...
    value: function getPages() {
      ...
      this.state.quickprevIconClass = showPrevMore ? this.state.quickprevIconClass : 'r-el-icon-more';
      this.state.quicknextIconClass = showNextMore ? this.state.quicknextIconClass : 'r-el-icon-more';
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'ul',
        { onClick: this.onPagerClick.bind(this), className: 'r-el-pager' },
        ...
        this.state.showPrevMore && _react2.default.createElement('li', {
          className: this.classNames('r-el-icon more btn-quickprev', quickprevIconClass),
          onMouseEnter: function onMouseEnter() {
            _this2.setState({ quickprevIconClass: 'r-el-icon-d-arrow-left' });
          },
          onMouseLeave: function onMouseLeave() {
            _this2.setState({ quickprevIconClass: 'r-el-icon-more' });
          }
        }),
        ...
        this.state.showNextMore && _react2.default.createElement('li', {
          className: this.classNames('r-el-icon more btn-quicknext', quicknextIconClass),
          onMouseEnter: function onMouseEnter() {
            _this2.setState({ quicknextIconClass: 'r-el-icon-d-arrow-right' });
          },
          onMouseLeave: function onMouseLeave() {
            _this2.setState({ quicknextIconClass: 'r-el-icon-more' });
          }
        }),
