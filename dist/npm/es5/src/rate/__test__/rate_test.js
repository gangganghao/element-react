...
test('Basic usage', function () {
  ...
  var rate1 = component1.find('.r-el-rate .r-el-rate__item').at(1);
  ...
  var rate2 = component1.find('.r-el-rate .r-el-rate__item').at(2);
  ...
  var rate3 = component2.find('.r-el-rate .r-el-rate__item').at(3);
...
test('With text', function () {
  ...
  // 模拟component2的第四个星 click事件
  var rate = component.find('.r-el-rate .r-el-rate__item').at(3);
  rate.simulate('click');
...
test('Read-only', function () {
  ...
  var rate = component.find('.r-el-rate .r-el-rate__item').at(4);
  rate.simulate('click');
