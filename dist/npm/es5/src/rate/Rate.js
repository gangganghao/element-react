  ...
  (0, _createClass3.default)(Rate, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: this.style(), className: this.className('r-el-rate') },
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              'i',
              {
                ...
                className: hoverIndex === k ? 'hover r-el-rate__icon ' + _this2.classes()[k] : 'r-el-rate__icon ' + _this2.classes()[k]
              },
              _this2.showDecimalIcon(k) ? _react2.default.createElement('i', {
                style: _this2.decimalStyle(),
                className: 'r-el-rate__decimal ' + _this2.decimalIconClass()
              }) : null
            )
          );
        }),
        showText ? _react2.default.createElement(
          'span',
          { className: 'r-el-rate__text', style: { color: textColor } },
          this.showText()
        ) : null
      );
    }
