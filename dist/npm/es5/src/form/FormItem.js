  ...
  (0, _createClass3.default)(FormItem, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: this.style(), className: this.className('r-el-form-item', {
            'is-error': error !== '',
        ...
        label && _react2.default.createElement(
          'label',
          { className: 'r-el-form-item__label', style: this.labelStyle() },
          typeof label === 'string' ? label + this.parent().props.labelSuffix : label
        ),
        _react2.default.createElement(
          'div',
          { className: 'r-el-form-item__content', style: this.contentStyle() },
          this.props.children,
          _react2.default.createElement(
            _libs.Transition,
            ...
            error && _react2.default.createElement(
              'div',
              { className: 'r-el-form-item__error' },
              error
            )
          )
        )
