      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            type && React.createElement('i', { className: this.classNames('r-el-notification__icon', this.typeClass(), iconClass) }),
            React.createElement(
              'div',
              {
                className: this.classNames('r-el-notification__group', {
                  'is-with-icon': this.typeClass() || iconClass
                })
              },
              React.createElement(
                'h2',
                { className: 'r-el-notification__title' },
                title
              ),
              React.createElement(
                'div',
                { className: 'r-el-notification__content' },
                message
              ),
              React.createElement('div', { className: 'r-el-notification__closeBtn r-el-icon-close', onClick: this.onClose.bind(this) })
            )
          )
        )
      );
