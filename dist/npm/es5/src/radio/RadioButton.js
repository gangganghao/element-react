  ...
  (0, _createClass3.default)(RadioButton, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'label',
        { style: this.style(), className: this.className('r-el-radio-button', this.props.size && 'r-el-radio-button--' + this.size(), {
        ...
        _react2.default.createElement(
          'span',
          { className: 'r-el-radio-button__inner', style: this.state.checked ? this.activeStyle() : {} },
