    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          !value && !showPanelColor && React.createElement('span', { className: 'r-el-color-picker__empty r-el-icon-close' })
        ),
        React.createElement('span', { className: 'r-el-color-picker__icon r-el-icon-caret-bottom' })
      ),
