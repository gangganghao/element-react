  ...
  Table.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      props.showHeader && React.createElement(
        'div',
        { className: 'r-el-table__header-wrapper', ref: this.bindRef('headerWrapper') },
      ...
      React.createElement(
        ...
        (!props.data || !props.data.length) && React.createElement(
          ...
          React.createElement(
            'span',
            { className: 'r-el-table__empty-text' },
            props.emptyText
          )
        )
      ),
      ...
      !!tableStoreState.fixedColumns.length && React.createElement(
        ...
        props.showHeader && React.createElement(
          'div',
          { className: 'r-el-table__fixed-header-wrapper', ref: this.bindRef('fixedHeaderWrapper') },
        ...
        props.showSummary && React.createElement(
          'div',
          { className: 'r-el-table__fixed-footer-wrapper', ref: this.bindRef('fixedFooterWrapper') },
      ...
      !!tableStoreState.rightFixedColumns.length && React.createElement(
        ...
        props.showHeader && React.createElement(
          'div',
          { className: 'r-el-table__fixed-header-wrapper', ref: this.bindRef('rightFixedHeaderWrapper') },
          React.createElement(TableHeader, _extends({
            fixed: 'right'
          }, this.props, {
            style: { width: this.bodyWidth || '' }
      ...
      React.createElement('div', { className: 'r-el-table__column-resize-proxy', ref: this.bindRef('resizeProxy'), style: { visibility: 'hidden' } })
    );
  };
