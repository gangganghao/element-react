...
var AutoComplete = function (_Component) {
  ...
  AutoComplete.prototype.highlight = function highlight(index) {
    ...
    if (reference instanceof HTMLElement) {
      var suggestion = document.querySelector('.r-el-autocomplete-suggestion__wrap');
      var suggestionList = document.querySelectorAll('.r-el-autocomplete-suggestion__list li');
  ...
  AutoComplete.prototype.render = function render() {
    ...
    return React.createElement(
      'div',
      { style: this.style(), className: this.className('r-el-autocomplete') },
