...
var Button = function (_Component) {
  ...
  Button.prototype.render = function render() {
    return React.createElement(
      ...
      this.props.loading && React.createElement('i', { className: 'r-el-icon-loading' }),
      this.props.icon && !this.props.loading && React.createElement('i', { className: 'r-el-icon-' + this.props.icon }),
      React.createElement(
        'span',
        null,
        this.props.children
