  ...
  Switch.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        View,
        { show: disabled },
        React.createElement('div', { className: 'r-el-switch__mask' })
      ),
      ...
      React.createElement(
        ...
        React.createElement('span', { className: 'r-el-switch__button', style: Object.assign({}, buttonStyle), onClick: this.setFocus.bind(this) })
      ),
      React.createElement(
        Transition,
        { name: 'label-fade' },
