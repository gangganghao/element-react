...
var Tabs = function (_Component) {
  ...
  Tabs.prototype.render = function render() {
    ...
    var addButton = editable || addable ? React.createElement(
      ...
      React.createElement('i', { className: 'r-el-icon-plus' })
    ) : null;
    var scrollBtn = scrollable ? [React.createElement(
      ...
      React.createElement('i', { className: 'r-el-icon-arrow-left' })
    ), React.createElement(
      'span',
      {
      ...
      React.createElement('i', { className: 'r-el-icon-arrow-right' })
    )] : null;
    this.tabs = [];
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.Children.map(children, function (item, index) {
                ...
                return React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement('span', { className: 'r-el-icon-close', onClick: function onClick(e) {
              ...
              React.createElement(
                View,
                { show: !type },
                React.createElement('div', { className: 'r-el-tabs__active-bar', style: barStyle })
              )
            )
          )
        )
