...
var Select = function (_Component) {
  ...
  Select.prototype.onVisibleChange = function onVisibleChange(visible) {
    ...
    if (!visible) {
      ...
      if (this.refs.root.querySelector('.r-el-input__icon')) {
        var elements = this.refs.root.querySelector('.r-el-input__icon');
      ...
      var icon = this.refs.root.querySelector('.r-el-input__icon');

      if (icon && !icon.classList.contains('r-el-icon-circle-close')) {
        var _elements = this.refs.root.querySelector('.r-el-input__icon');
  ...
  Select.prototype.render = function render() {
    ...
    return React.createElement(
      'div',
      { ref: 'root', style: this.style(), className: this.className('r-el-select') },
      multiple && React.createElement(
        'div',
        { ref: 'tags', className: 'r-el-select__tags', onClick: this.toggleMenu.bind(this), style: {
        ...
        selected.map(function (el) {
          return React.createElement(
            ...
            React.createElement(
              'span',
              { className: 'r-el-select__tags-text' },
              el.currentLabel()
            )
          );
        }),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            this.emptyText() && React.createElement(
              'p',
              { className: 'r-el-select-dropdown__empty' },
              this.emptyText()
            )
          )
        )
