...
var Progress = function (_Component) {
  ...
  Progress.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      {
        style: this.style(),
        className: this.className('r-el-progress', 'r-el-progress--' + type, (_className = {}, _className['is-' + status] = !!status, _className['r-el-progress--without-text'] = !showText, _className['r-el-progress--text-inside'] = textInside, _className))
      },
      progress,
      progressInfo
    );
